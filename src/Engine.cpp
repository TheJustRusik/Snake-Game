...
void Engine::play() {
    ...
    std::thread thread2([&]() {
        ...
        while (true) {
            ...
            << "             "; SetConsoleCursorPosition(h, { 25,4 }); std::cout
            << "Eaten apples: " << apples; SetConsoleCursorPosition(h, { 25,5
            ...
            */
            ...
            if (position.X == 0 or position.X == (width - 1) or
                position.Y == 0 or position.Y == (height - 1)) {
            ...
            LOL:
                ...
                while (field[appleY][appleX] != AIR or
                       isInBody(appleX, appleY)) {
                    for (auto i : body) {
